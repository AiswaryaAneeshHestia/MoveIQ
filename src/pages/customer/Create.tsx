      ...
      <Container className="px-4 mt-5 shadow-sm rounded" style={{backgroundColor:"white",fontFamily:"Urbanist"}}>
        ...
        <Form onSubmit={handleSubmit} className="p-4">
          <Row>
            ...
            <Col md={6} className="mb-3">
              <Form.Label className="fw-semibold">Registered Date</Form.Label>
            ...
            <Col md={6} className="mb-3">
              ...
              <Form.Control type="text" name="nationality" placeholder="Enter nationality" value={formData.nationality} onChange={handleChange} onBlur={() => validateField("nationality",formData.nationality)} />
