...
const Attachments: React.FC<AttachmentsProps> = ({ tableName, recordId }) => {
    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            // Success - refresh attachments and close modal
    ...
    //  Modified delete function to use modal instead of alert
    ...
    const getFileIcon = (fileName: string) => {
        ...
        switch (ext) {
            ...
            case "jpeg":
            case "gif":
                return <FileImage size={20} className="text-warning" />;

            case "zip":
            case "rar":
                return <FileArchive size={20} className="text-secondary" />;

            case "mp3":
            case "wav":
                return <FileAudio size={20} className="text-info" />;

            case "mp4":
            case "mov":
            case "avi":
                return <FileVideo size={20} className="text-info" />;

            case "json":
                return <FileJson size={20} className="text-muted" />;
            ...
            default:
                return <FileType size={20} className="text-dark" />;
        }
    };
                                ...
                                <Table bordered hover responsive className="mb-0">
                                    <thead style={{ backgroundColor: "#e9ecef" }}>
                                        <tr className="text-center">
                                            <th style={{ width: "5%" }} className="bg-secondary text-white">SL</th>
                                            <th style={{ width: "30%" }} className="bg-secondary text-white">File Name</th>
                                            <th style={{ width: "20%" }} className="bg-secondary text-white">Description</th>
                                            <th style={{ width: "10%" }} className="bg-secondary text-white">Size</th>
                                            <th style={{ width: "25%" }} className="bg-secondary text-white">Uploaded</th>
                                            <th style={{ width: "5%" }} className="bg-secondary text-white">
                                                Actions
                                            </th>
                                        </tr>
                                    </thead>
                                                    ...
                                                    <div className="d-flex gap-1 justify-content-center">
                                                        ...
                                                        <OverlayTrigger overlay={<Tooltip>Delete</Tooltip>}>
                                                            <Button
                                                                ...
                                                                size="sm"
                                                                onClick={() =>
                                                                    confirmDeleteAttachment(attachment.attachmentId)
                                                                }
                                                            // onClick={() =>
            ...
            <Modal show={showModal} onHide={handleCloseModal} centered size="lg" className="head-font">
                ...
                <Modal.Body>
                    ...
                    <div
                        {...getRootProps()}
                        style={{
                            border: "2px dashed #18575A",
                            borderRadius: "8px",
                            padding: "40px",
                            textAlign: "center",
                            cursor: "pointer",
                            backgroundColor: isDragActive ? "#e8f4f5" : "#f8f9fa",
